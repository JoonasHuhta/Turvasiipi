                ...
                <TabsContent value="thermometer" className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                    <div className="bg-white border border-suojasiipi-secondary p-8 md:p-12 rounded-sm shadow-sm space-y-8">
                        <div className="flex items-center gap-3 border-b border-[#FAFAFA] pb-4">
                            ...
                            <h2 className="text-xl font-serif font-bold text-suojasiipi-text-main">{t('lukutaito_page.thermometer.title')}</h2>
                        </div>
                            ...
                            <AccordionItem value="yellow" className="bg-white border-l-4 border-l-yellow-400 border border-suojasiipi-secondary rounded-sm px-4">
                                <AccordionTrigger className="hover:no-underline py-6">
                                    <div className="flex items-start gap-4 text-left">
                                        ...
                                        <div>
                                            <h3 className="text-lg font-bold text-suojasiipi-text-main">{t('lukutaito_page.warning_signs.yellow.title')}</h3>
                                            <p className="text-sm text-suojasiipi-text-body">{t('lukutaito_page.warning_signs.yellow.subtitle')}</p>
                                        </div>
                                    </div>
                                </AccordionTrigger>
                                <AccordionContent className="pb-8 pl-16 grid gap-8">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-8">
                                        <div className="bg-suojasiipi-bg p-6 rounded-sm border border-suojasiipi-secondary">
                                            <h4 className="font-bold text-sm uppercase tracking-wider mb-4 text-suojasiipi-text-main">{t('lukutaito_page.warning_signs.yellow.power_signs_title')}</h4>
                                        ...
                                        <div className="bg-suojasiipi-bg p-6 rounded-sm border border-suojasiipi-secondary">
                                            <h4 className="font-bold text-sm uppercase tracking-wider mb-4 text-suojasiipi-text-main">{t('lukutaito_page.warning_signs.yellow.atmosphere_signs_title')}</h4>
                                            <ul className="space-y-2 text-sm text-suojasiipi-text-body">
