...
import { ArrowRight, Menu, X, Globe, Gamepad2, Search, User, Wrench, Heart, ChevronDown } from "lucide-react";

export default function Hiekkalaatikko4Page() {
    const [isMenuOpen, setIsMenuOpen] = useState(false);

    return (
        <div className="min-h-screen bg-[#FDFBF7] text-[#2B2B2B] font-serif selection:bg-[#E8DDD0] selection:text-[#2B2B2B] antialiased">

            {/* Navigation */}
            <nav className="fixed top-0 w-full z-50 bg-[#FDFBF7]/95 backdrop-blur-md border-b border-[#E8DDD0]">
                <div className="max-w-screen-xl mx-auto px-6 h-20 flex items-center justify-between">

                    {/* Left side: Brand */}
                    <div className="flex items-center gap-4">
                        <span className="text-sm font-bold tracking-tight text-[#2B2B2B]">TURVASIIPI</span>
                    ...
                    {/* Middle: Desktop Nav */}
                    <div className="hidden lg:flex items-center gap-8 text-[12px] font-medium tracking-wide text-[#4A4A4A]">
                        <Link href="/simulaatio" className="hover:text-[#5B4B8A] transition-colors">KOE</Link>
                        <Link href="#" className="hover:text-[#5B4B8A] transition-colors">TUTKI</Link>
                        <Link href="#" className="hover:text-[#5B4B8A] transition-colors">VALMENNUS</Link>
                        <Link href="#" className="hover:text-[#5B4B8A] transition-colors">VÄLINEET</Link>
                    </div>

                    {/* Right side: Mobile Menu Trigger + Close */}
                    <div className="flex items-center gap-4">
                        <div className="hidden md:flex items-center gap-2 px-4 py-2 bg-white border border-[#E8DDD0] hover:border-[#5B4B8A]/30 rounded-full text-[11px] font-bold tracking-wide text-[#5B4B8A] transition-all cursor-pointer shadow-sm hover:shadow-md">
                            <Heart className="w-3.5 h-3.5" />
                            <span>APUA</span>
                        </div>

                        <Link href="/" className="hidden sm:block text-[11px] font-medium tracking-wide text-[#4A4A4A] hover:text-[#2B2B2B] transition-colors">
                            SULJE
                        </Link>
                ...
                {/* Mobile Menu Overlay */}
                {isMenuOpen && (
                    <div className="lg:hidden fixed inset-0 top-20 bg-[#FDFBF7] z-[60] p-8 border-t border-[#E8DDD0] animate-in fade-in slide-in-from-top-2">
                        <div className="space-y-6">
                            <Link href="/simulaatio" className="block py-3 text-lg font-serif border-b border-[#E8DDD0]">Koe Simulaatio</Link>
                            <Link href="#" className="block py-3 text-lg font-serif border-b border-[#E8DDD0]">Tutki</Link>
                            <Link href="#" className="block py-3 text-lg font-serif border-b border-[#E8DDD0]">Valmennus</Link>
                            <Link href="#" className="block py-3 text-lg font-serif border-b border-[#E8DDD0]">Välineet</Link>
                            <div className="pt-4">
                                <Link href="/" className="text-sm font-mono uppercase tracking-widest text-[#4A4A4A]">
                                    — Sulje
                                </Link>
                            </div>
                        </div>
            ...
            <main className="pt-40 pb-32 px-6 sm:px-8 max-w-screen-md mx-auto space-y-32">
            ...
            {/* Footer */}
            <footer className="bg-[#F0EEE6] border-t border-[#E8DDD0] py-24 px-8 text-center space-y-12">
