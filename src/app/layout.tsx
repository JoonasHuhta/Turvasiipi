    ...
    <html lang="fi">
      <body className={inter.className}>
        <div className="min-h-screen bg-background flex flex-col items-center">
          <header className="w-full max-w-4xl p-6 flex justify-between items-center bg-white/50 backdrop-blur-sm sticky top-0 z-50 rounded-b-xl mb-4 border-b border-white/20">
