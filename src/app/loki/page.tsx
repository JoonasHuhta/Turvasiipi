            ...
            <main className="max-w-2xl mx-auto px-6 py-8 space-y-8">
                    ...
                    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        ...
                        <div className="bg-white p-6 rounded-sm shadow-sm border border-[#E8DDD0] space-y-4">
                            <div className="flex gap-4">
                                ...
                                <div>
                                    <h3 className="font-bold text-[#2B2B2B]">{t('log_tool.header.steps.step1_title')}</h3>
                                    <p className="text-sm text-[#4A4A4A] mt-1">{t('log_tool.header.steps.step1_text')}</p>
                                </div>
                            </div>
                            <div className="flex gap-4">
                                <div className="w-10 h-10 rounded-full bg-[#FDFBF7] border border-[#E8DDD0] flex items-center justify-center shrink-0">
                                ...
                                <div>
                                    <h3 className="font-bold text-[#2B2B2B]">{t('log_tool.header.steps.step2_title')}</h3>
                                    <p className="text-sm text-[#4A4A4A] mt-1">{t('log_tool.header.steps.step2_text')}</p>
                                </div>
                            </div>
                            <div className="flex gap-4">
                                <div className="w-10 h-10 rounded-full bg-[#FDFBF7] border border-[#E8DDD0] flex items-center justify-center shrink-0">
                                ...
                                <div>
                                    <h3 className="font-bold text-[#2B2B2B]">{t('log_tool.header.steps.step3_title')}</h3>
                                    <p className="text-sm text-[#4A4A4A] mt-1">{t('log_tool.header.steps.step3_text')}</p>
                                </div>
                            </div>
                        </div>
                ...
                {step === 1 && (
                    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        <div className="text-center space-y-2">
                            <h1 className="text-2xl font-serif font-bold text-[#2B2B2B]">{t('log_tool.step1.title')}</h1>
                            <p className="text-[#4A4A4A]">{t('log_tool.step1.subtitle')}</p>
                        </div>
                ...
                {step === 2 && (
                    <div className="space-y-6 animate-in fade-in slide-in-from-right-8 duration-500">
                        <div className="text-center space-y-2">
                            <h1 className="text-2xl font-serif font-bold text-[#2B2B2B]">{t('log_tool.step2.title')}</h1>
                            <p className="text-[#4A4A4A]">{t('log_tool.step2.subtitle')}</p>
                        </div>
